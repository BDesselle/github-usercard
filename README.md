...
* Create an if/else for if some user content is missing. This prevents `null` where profile data should be displayed.
* Convert cards to modals with double click event listener that opens up to display more user data.
* Add a clickable element to direct to the user's Github account.
